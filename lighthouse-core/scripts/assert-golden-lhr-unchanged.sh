...
node "$lhroot_path/lighthouse-cli" -A="$lhroot_path/lighthouse-core/test/results/artifacts" --config-preset=observed --quiet --output=json --output-path="$freshLHRPath" http://localhost/dobetterweb/dbw_tester.html
set +x
